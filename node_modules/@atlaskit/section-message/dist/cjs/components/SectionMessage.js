...
var custom_theme_button_1 = tslib_1.__importDefault(require("@atlaskit/button/custom-theme-button"));
...
var SectionMessage = /** @class */ (function (_super) {
    ...
    function SectionMessage() {
        ...
        _this.renderAction = function (action, linkComponent) {
            ...
            return (react_1.default.createElement(styled_1.Action, { key: key, "data-testid": testId }, onClick || href ? (react_1.default.createElement(custom_theme_button_1.default, { appearance: "link", spacing: "none", onClick: onClick, href: href, component: linkComponent }, text)) : (text)));
        };
        return _this;
    }
